...
import { allOrders, deleteOrderById, getOrderDetailsById, getSales, myOrders, newOrder, updateOrderDetailsById } from "../controllers/orderControllers.js";
...
router.route("/admin/order/:id").put(isAuthenticated, authorizeRoles("admin"), updateOrderDetailsById);
router
